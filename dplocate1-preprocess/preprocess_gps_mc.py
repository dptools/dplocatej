...
def main():
    ...
    argparser.add_argument('--matlab-dir',
        ...
        default='/ncf/nrg/sw/lib/preprocess_gps_mc/master/')

    argparser.add_argument('--pipeline',
        help='Name of the pipeline to run. Default: preprocess_gps_mc',
    ...
    argparser.add_argument('--include',
        help='All subjects or only the active ones. Default: all',
        default='all')
